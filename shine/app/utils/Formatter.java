...
public class Formatter {
    ...
    public static String formatDate(Object dateText) {
    	if (dateText != null) {
			...
			String newDate = new java.text.SimpleDateFormat("MMM dd yyyy").format(date);
			return newDate;
    	}
		return "";
	}

    public static String formatDateToDDMMYY(Object dateText) {
    	if (dateText != null) {
			String dateValue = dateText.toString();
			DateFormat formatter = new SimpleDateFormat("E MMM dd HH:mm:ss Z yyyy");
			Date date;
			...
			String newDate = new java.text.SimpleDateFormat("dd/MM/yyyy").format(date);
			return newDate;
    	}
		return "";
	}

    public static String formatDateTime(Object dateText) {
    	if (dateText != null) {
			String dateValue = dateText.toString();
			DateFormat formatter = new SimpleDateFormat("E MMM dd HH:mm:ss Z yyyy");
			Date date;
